# DEVELOPED IN REFERENCE TO http://robromijnders.github.io/cnn_music/
# Code is originally build for classification task but we modified it to save and play the signal we feed in.

#-------------play around with our training data---------------------------------


# ----- Input signal is an array -------------------
...
with tf.Session() as sess:
  writer = tf.summary.FileWriter("/home/student/s/snambusubram/Downloads/cnn_music-master/log_tb", sess.graph_def)
